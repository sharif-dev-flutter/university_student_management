import 'package:attendencedemo/logged_in/student/applyleave.dart';
import 'package:attendencedemo/logged_in/teacher/applicationdetails.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';


class ViewApplicationList extends StatefulWidget {
  @override
  _ViewApplicationListState createState() => _ViewApplicationListState();
}

class _ViewApplicationListState extends State<ViewApplicationList> {
  @override
                  ...
                  for (var i in _leaverequestdata){
                    final leaverequestwWidget = Container(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>ApplicationDetails()));
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            crossAxisAlignment: CrossAxisAlignment.center,

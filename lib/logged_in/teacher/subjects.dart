...
import 'package:attendencedemo/logged_in/teacher/result.dart';
import 'package:attendencedemo/logged_in/teacher/routine.dart';
import 'package:attendencedemo/logged_in/teacher/viewapplicationlist.dart';
              ...
              Expanded(
                child: ListView(
                  children: <Widget>[
                    ...
                    ListTile(
                      title: Text('View Leave list'),
                      onTap: () async{
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ViewApplicationList()));
